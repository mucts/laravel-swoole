...
use MuCTS\Http\HotReload\FSEvent;
use MuCTS\Http\HotReload\FSOutput;
use MuCTS\Http\HotReload\FSProcess;
use MuCTS\Http\Server\AccessOutput;
use MuCTS\Http\Server\PidManager;
use MuCTS\Http\Middleware\AccessLog;
...
class HttpServerCommand extends Command
{
    ...
    /**
     * @param \MuCTS\Http\Server\Facades\Server $server
     *
