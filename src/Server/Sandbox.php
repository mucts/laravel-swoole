...
use MuCTS\Http\Coroutine\Context;
use Illuminate\Contracts\Http\Kernel;
use Illuminate\Support\Facades\Facade;
use MuCTS\Http\Concerns\ResetApplication;
use MuCTS\Http\Exceptions\SandboxException;
...
class Sandbox
{
     ...
     *
     * @throws \MuCTS\Http\Exceptions\SandboxException
     */
     ...
     *
     * @return \MuCTS\Http\Server\Sandbox
     */
