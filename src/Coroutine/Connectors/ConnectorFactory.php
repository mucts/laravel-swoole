...
namespace MuCTS\Http\Coroutine\Connectors;
...
class ConnectorFactory
{
     ...
     * @const string
     */
    public const CONNECTOR_CLASS = 'MuCTS\Http\Coroutine\Connectors\MySqlConnector';
     ...
     *
     * @return \MuCTS\Http\Coroutine\Connectors\MySqlConnector
     */
