...
namespace MuCTS\Http\Concerns;

use Throwable;
use Illuminate\Pipeline\Pipeline;
use MuCTS\Http\Server\Sandbox;
use MuCTS\Http\Websocket\Parser;
use MuCTS\Http\Websocket\Pusher;
use MuCTS\Http\Websocket\Websocket;
use MuCTS\Http\Transformers\Request;
use MuCTS\Http\Server\Facades\Server;
use MuCTS\Http\Websocket\HandlerContract;
use Illuminate\Contracts\Container\Container;
use Swoole\WebSocket\Server as WebsocketServer;
use MuCTS\Http\Websocket\Rooms\RoomContract;
use MuCTS\Http\Exceptions\WebsocketNotSetInConfigException;
...
trait InteractsWithWebsocket
{
    ...
    /**
     * @var \MuCTS\Http\Websocket\HandlerContract
     */
    protected $websocketHandler;

    /**
     * @var \MuCTS\Http\Websocket\Parser
     */
    protected $payloadParser;

    /**
     * @var \MuCTS\Http\Websocket\Rooms\RoomContract
     */
     ...
     *
     * @param \MuCTS\Http\Websocket\Parser $payloadParser
     *
     * @return \MuCTS\Http\Concerns\InteractsWithWebsocket
     */
     ...
     *
     * @param \MuCTS\Http\Websocket\HandlerContract $handler
     *
     * @return \MuCTS\Http\Concerns\InteractsWithWebsocket
     */
     ...
     *
     * @return \MuCTS\Http\Websocket\HandlerContract
     */
     ...
     *
     * @return \MuCTS\Http\Websocket\Rooms\RoomContract
     */
