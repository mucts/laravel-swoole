...
namespace MuCTS\Http\Task;

use Illuminate\Support\Arr;
use MuCTS\Http\Helpers\FW;
use MuCTS\Http\Task\SwooleTaskQueue;
...
class QueueFactory
{
     ...
     * @const string
     */
    public const QUEUE_CLASS = 'MuCTS\Http\Task\SwooleTaskQueue';
     ...
     *
     * @return \MuCTS\Http\Task\SwooleTaskQueue
     */
