...
namespace MuCTS\Http\Tests\Server;

use Mockery as m;
use Swoole\Table;
use Swoole\Http\Request;
use Swoole\Http\Response;
use MuCTS\Http\Server\Manager;
use MuCTS\Http\Server\Sandbox;
use MuCTS\Http\Tests\TestCase;
use Illuminate\Container\Container;
use MuCTS\Http\Websocket\HandShakeHandler;
use MuCTS\Http\Websocket\Parser;
use MuCTS\Http\Server\PidManager;
use MuCTS\Http\Table\SwooleTable;
...
use MuCTS\Http\Websocket\Rooms\TableRoom;
use MuCTS\Http\Websocket\Rooms\RoomContract;
use Illuminate\Contracts\Debug\ExceptionHandler;
use MuCTS\Http\Websocket\SocketIO\SocketIOParser;
use MuCTS\Http\Websocket\SocketIO\WebsocketHandler;
use Illuminate\Contracts\Config\Repository as ConfigContract;
use MuCTS\Http\Websocket\Facades\Websocket as WebsocketFacade;
...
class ManagerTest extends TestCase
{
    ...
    {
        parent::mockMethod($name, $function, 'MuCTS\Http\Server');
    }
}
